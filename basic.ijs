...
testbasicgemm=: 3 : 0
  ...
  NB. BLIS xgemm supports float and complex datatypes only
  if. '' -: (3!:0 S: 0 y) -. JFL , JCMPX do.
...
testbasicgemmt=: 3 : 0
  NB. BLIS xgemmt supports float and complex datatypes only
  if. '' -: (3!:0 S: 0 y) -. JFL , JCMPX do.
    'As Bs C'=. y
    dcoeff=. 0.0 1.0 0.7
    zcoeff=. 0j0 1j0 0.7j_0.9
...
testbasicsymm=: 3 : 0
  ...
  NB. BLIS xsymm supports float and complex datatypes only
  if. '' -: (3!:0 S: 0 y) -. JFL , JCMPX do.
...
testbasichemm=: 3 : 0
  ...
  NB. BLIS xhemm supports float and complex datatypes only
  if. '' -: (3!:0 S: 0 y) -. JFL , JCMPX do.
    argsam=. { (<"0 acoeff) ; (< Am) ; (< B) ; (<"0 acoeff) ; < < C
    argsan=. { (<"0 acoeff) ; (< An) ; (< B) ; (<"0 acoeff) ; < < C
...
testbasictrmm=: 3 : 0
  ...
  NB. BLIS xtrmm supports float and complex datatypes only
  if. '' -: (3!:0 S: 0 y) -. JFL , JCMPX do.
...
testbasictrsm=: 3 : 0
  ...
  NB. BLIS xtrsm supports float and complex datatypes only
  if. '' -: (3!:0 S: 0 y) -. JFL , JCMPX do.
