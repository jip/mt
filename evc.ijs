...
:
  ...
  while. je >: 0 do.
    if. *./ FP_SFMIN >: (je { ios) {"1 d2 do.
      ...
      work=. ((>: je) {. _1 { y) u work  NB. when backtransform, (ios -: i. n) <=> (je -: je { ios)
      NB. scale eigenvector and append X to it
      X=. ((0:`%@.(FP_SFMIN<]) normit) work) appendl X
    end.
    je=. <: je
  end.
  X
...
:
  ...
  while. je >: 0 do.
    if. *./ FP_SFMIN >: (je { ios) {"1 d2 do.
      ...
      X=. ((0:`%@.(FP_SFMIN<]) normit) work) stitcht X
    end.
    je=. <: je
  end.
  X
...
tgevcly2=: (,~)`, `((0,],0:),:(2 1,]))`(1 0 2&|:)` {.   `(mp~)`appendl tgevclyux
tgevcux2=:  ,  `,.`((0 0,]),:(2,],1:))`(2 0 1&|:)`({."1)` mp  `stitcht tgevclyux
...
:
  ...
  while. je < k do.
    if. *./ FP_SFMIN >: (je { ios) {"1 d2 do.
      ...
      NB. optional back transforming
      work=. (je }. 2 ({ :: 0:) y) u work  NB. when backtransform, (ios -: i. n) <=> (je -: je { ios)
      NB. scale eigenvector and append to Y
      Y=. Y appendr (0:`%@.(FP_SFMIN<]) normit) work
    end.
    je=. >: je
  end.
  Y
...
:
  ...
  while. je < k do.
    if. *./ FP_SFMIN >: (je { ios) {"1 d2 do.
      ...
      Y=. Y stitchb (0:`%@.(FP_SFMIN<]) normit) work
    end.
    je=. >: je
  end.
  Y
...
tgevclx2=: (,~)`, `((0,, ),:(2 1,- ))`(1 0 2&|:)` }.   `(mp~)`appendr tgevclxuy
tgevcuy2=:  ,  `,.`((0,,~),:(2,-,1:))`(2 0 1&|:)`(}."1)` mp  `stitchb tgevclxuy
...
tgevcllb=: ((i.@c) (; norm1tr tgevci) (2&{.)) (mp~ tgevcly) ]
tgevcllb2=: ((i.@c) (; norm1tr tgevci) (2&{.)) tgevcly2 ]
tgevclrb=: ((i.@c) (; norm1tr tgevci) (2&{.)) (mp~ tgevclx) ]
tgevclrb2=: ((i.@c) (; norm1tr tgevci) (2&{.)) tgevclx2 ]
tgevclbb=: ((i.@c) (; norm1tr tgevci) (2&{.)) ((mp~ tgevcly) ,: (mp~ tgevclx)) ]

tgevculb=: ((i.@c) (; norm1tc tgevci) (2&{.)) (mp tgevcuy) ]
tgevculb2=: ((i.@c) (; norm1tc tgevci) (2&{.)) tgevcuy2 ]
tgevcurb=: ((i.@c) (; norm1tc tgevci) (2&{.)) (mp tgevcux) ]
tgevcurb2=: ((i.@c) (; norm1tc tgevci) (2&{.)) tgevcux2 ]
tgevcubb=: ((i.@c) (; norm1tc tgevci) (2&{.)) ((mp tgevcuy) ,: (mp tgevcux)) ]
