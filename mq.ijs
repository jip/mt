...
NB. ---------------------------------------------------------
unm2rlnstep=: ((,;.0)~(_ 1,:~2$((0{$@(0&{::)))))larflnfc(1{::])
unm2rlcstep=: ((,;.0)~(_ 1,:~2$((0{$@(0&{::)))))larflcfc(1{::])
unm2rrnstep=: ((,;.0)~(_ 1,:~2$((1{$@(0&{::)))))larfrnfc(1{::])
unm2rrcstep=: ((,;.0)~(_ 1,:~2$((1{$@(0&{::)))))larfrcfc(1{::])

NB. ---------------------------------------------------------
unmr2lnstep=: ((,;.0)~(1 _,:~2$(-@>:@(0{$@(1&{::)))))larflcbr(0{::])
unmr2lcstep=: ((,;.0)~(1 _,:~2$(-@>:@(0{$@(1&{::)))))larflnbr(0{::])
unmr2rnstep=: ((,;.0)~(1 _,:~2$(-@>:@(1{$@(1&{::)))))larfrcbr(0{::])
unmr2rcstep=: ((,;.0)~(1 _,:~2$(-@>:@(1{$@(1&{::)))))larfrnbr(0{::])
...
NB. ---------------------------------------------------------
NB. Verb     Action  Side   Tran  Syntax
NB. unm2rln  Q * C   left   none  QeC=.  Qf unm2rln (C, 0)
NB. unm2rlc  Q'* C   left   ct    cQeC=. Qf unm2rlc (C, 0)
NB. unm2rrn  C * Q   right  none  eCQ=.  Qf unm2rlc (C,.0)
NB. unm2rrc  C * Q'  right  ct    eCcQ=. Qf unm2rlc (C,.0)
NB.
NB. Description:
NB.   Multiply a general matrix C by matrix Q, which is
...
NB.   Q=. unglq LQf
NB. then
NB.   clean ((trl1 geqrf A) unm2rln ((ct ungqr geqrf A) , 0))           CLARIFYME!
NB.   clean ((trl1 geqrf A) unm2rlc ((ungqr geqrf A) , 0))              CLARIFYME!
NB.   clean ((trl1 geqrf A) unm2rrn ((ct ungqr geqrf A) ,. 0))          CLARIFYME!
NB.   clean ((trl1 geqrf A) unm2rrc ((ungqr geqrf A) ,. 0))             CLARIFYME!
NB.
NB. Notes:
NB. - input's and output's shapes are the same
NB. - emulates LAPACK's xUNML2
...
unm2rln=: [((0{::]), unm2rlnstep)([(((0{::])(((, ~{:)~);~(_1  0&}.@[))unm2rlnstep)^:(<:@(1{$)@[))((({.;}.)~(<:@(1{$)))~))
unm2rlc=: [((0{::]), unm2rlcstep)( (((0{::])(( ,  {.  ); ( 1  0&}.@]))unm2rlcstep)^:(<:@(1{$)@[))(;~(0&{.)))
unm2rrn=: [((0{::]),.unm2rrnstep)( (((0{::])(( ,. hc  ); ( 0  1&}.@]))unm2rrnstep)^:(<:@(1{$)@[))(;~(_ 0&{.)))
unm2rrc=: [((0{::]),.unm2rrcstep)([(((0{::])(((,.~tc)~);~( 0 _1&}.@[))unm2rrcstep)^:(<:@(1{$)@[))(((({.~(_&,));(}.~(0&,)))(<:@(1{$)))~))

NB. ---------------------------------------------------------
NB. Verb     Action  Side   Tran  Syntax
NB. unmr2ln  Q * C   left   none  QeC=.  Qf unmr2ln (0, C)
NB. unmr2lc  Q'* C   left   ct    cQeC=. Qf unmr2lc (0, C)
NB. unmr2rn  C * Q   right  none  eCQ=.  Qf unmr2lc (0,.C)
NB. unmr2rc  C * Q'  right  ct    eCcQ=. Qf unmr2lc (0,.C)
NB.
NB. Description:
NB.   Multiply a general matrix C by matrix Q, which is
...
unmr2ln=: [(unmr2lnstep, (1{::]))( ((unmr2lnstep(((, ~{:)~);~(_1  0&}.@[))(1{::]))^:(<:@(0{$)@[))(; (0&{.)))
unmr2lc=: [(unmr2lcstep, (1{::]))([((unmr2lcstep(( ,  {.  ); ( 1  0&}.@]))(1{::]))^:(<:@(0{$)@[))((({.;~}.)~(-@<:@#))~))
unmr2rn=: [(unmr2rnstep,.(1{::]))([((unmr2rnstep(( ,. hc  ); ( 0  1&}.@]))(1{::]))^:(<:@(0{$)@[))((((}.~(0&,));({.~(_&,)))(-@<:@#))~))
unmr2rc=: [(unmr2rcstep,.(1{::]))( ((unmr2rcstep(((,.~tc)~);~( 0 _1&}.@[))(1{::]))^:(<:@(0{$)@[))(; (_ 0&{.)))
...
unmlqlnstep=: ((];.0~ (((UNMQBS >. -)&# 0&({::)) , _:)) ,:~ 2 $ 0 { $@(0&({::))) larfblcfr 1 {:: ]
unmlqln=: (unml2ln`([ ((0 {:: ]) , unmlqlnstep) (((0 {:: ]) ((, UNMQBS&{.) ; (UNMQBS,0)&}.@]) unmlqlnstep)^:(<.@(UNMQBS %~ (<:UNMQBS) + #@[)) (;~ 0&{.)))@.(UNMQBS < #@[)~ (tru1@({.~(<./@(0 _1 + $)))))~ ,&0
