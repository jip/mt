...
CPU_CACHE=: 512*1024                                  NB. cache size in (7!:5) units for Intel Pentium 4 and AMD Athlon
...
require '~user/projects/pjlap/chol.ijs'               NB. Cholesky decomposition
...
require '~user/projects/pjlap/pow.ijs'                NB. integer powers
require '~user/projects/pjlap/rot.ijs'                NB. plane rotations
require '~user/projects/pjlap/sv.ijs'                 NB. solve systems A*X=B
