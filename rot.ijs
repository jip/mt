...
FP_ESFMA=: 1 2 3 4 _1 _2 _3 _4 * >. 1r4 * (FP_BASE ^. FP_SFMIN % (FP_IGUF { (FP_EPS , 1)))
...
Note 'rot testing and timing'
   ...
   ts=: 6!:2, 7!:2@]
   load '/home/maya/j602-user/projects/pjlap/rot.ijs'
   2 ts 'z=. lartg_pjlap_ a'
13.005 3.10898e7
   2 ts 'z=. lartg_pjlap_ ac'
13.1008 3.10899e7
   ts 'z=. lartg_pjlap_ b'
   tlartg_pjlap_ ((4^2^2) , 2) $, (,"0/~) , (j./~) _ __ 0 _.
   tlartg_pjlap_ 0 ,.~ ~. , (j./~) 2 ^ _1074 _1020 _765 _510 _255 0 255 510 765 1020 1023
   tlartg_pjlap_ 0 ,. ~. , (j./~) 2 ^ _1074 _1020 _765 _510 _255 0 255 510 765 1020 1023
   ts 'z=. lartg_pjlap_ ((13^2^2) , 2) $, (,"0/~) , (j./~) 2 ^ _1074 _1020 _765 _510 _255 _10 0 10 255 510 765 1020 1023'
)
