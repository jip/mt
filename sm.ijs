...
trsmxu1h=: ( (((_1-(c@])) {"1 (1 {:: [)) - (] mp  (((c@]) (1 dhs2lios ((_1-*),[)) (# @ (0 {:: [))) +@({,) (0 {:: [)))                                                          ) ,.  ]) ^: (;`(c@])`(0 {."1 ]))  NB. lios(li)=(1 dhs2lios (-1-i*n,i))
trsmxu1t=: ( (((_1-(c@])) {"1 (1 {:: [)) - (] mp  (((c@]) (1 dhs2lios ((_1-*),[)) (# @ (0 {:: [)))   ({,) (0 {:: [)))                                                          ) ,.  ]) ^: (;`(c@])`(0 {."1 ]))  NB. lios(li)=(1 dhs2lios (-1-i*n,i))
trsmxuh=:  (((((_1-(c@])) {"1 (1 {:: [)) - (] mp  (((c@]) (1 dhs2lios ((_1-*),[)) (# @ (0 {:: [))) +@({,) (0 {:: [)))) % (((c@]) (_1-(* >:)) (# @ (0 {:: [))) +@({,) (0 {:: [))) ,.  ]) ^: (;`(c@])`(0 {."1 ]))  NB. lios(li)=(1 dhs2lios (-1-i*n,i)), lio(lii)=-1-i*(n+1)
trsmxut=:  (((((_1-(c@])) {"1 (1 {:: [)) - (] mp  (((c@]) (1 dhs2lios ((_1-*),[)) (# @ (0 {:: [)))   ({,) (0 {:: [)))) % (((c@]) (_1-(* >:)) (# @ (0 {:: [)))   ({,) (0 {:: [))) ,.  ]) ^: (;`(c@])`(0 {."1 ]))  NB. lios(li)=(1 dhs2lios (-1-i*n,i)), lio(lii)=-1-i*(n+1)
