...
NB.
NB. getrsu   Solve system U*X=B, where U is an upper
NB.          triangular matrix
NB. trtrsu   Solve system U*x=b, where U is an upper
NB.          triangular matrix in packed form
NB. getrsl   Solve system L*X=B, where L is a lower
NB.          triangular matrix
NB. getrsl1  Solve system L*X=B, where L is a unit lower
NB.          triangular matrix
...
NB.       N×N-matrix A, i-th row elements (i=0..(N-1)) are
