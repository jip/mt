...
NB.   Q   - m×n-matrix, real, with orthonormal rows, which is
...
NB.         returned by DGELQF, with the tau it represents
...
dorglq=: 3 : 0
  ...
  |: 4 {:: dorglq_jlapack2_ (, m) ; (, n) ; (, k) ; (|: A) ; (, 1 >. m) ; tau ; (lwork $ 0.0) ; lwork ; , _1
)
